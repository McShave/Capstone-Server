...
async def handle_device(device):
    async with BleakClient(device["address"], timeout=30.0) as client:
        ...
        def notification_handler(characteristic: BleakGATTCharacteristic, data: bytearray):
            ...
            # Map UUIDs to consistent sensor names
            if characteristic.uuid == device["smoke_level_uuid"]:
            ...
            sensor_id = db.add_sensor(sensor_name)  # Ensure consistent sensor names in the database
